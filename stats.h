// Provided by:   ____________(Carter Beebe)__________
// Lab:           ____________(OTT 182)________
// Course number: ____________(CIS-221)________
...
namespace main_savitch_2C
{
  ...
  public:
    ...
    //  sequence.
    Statistician( );
    Statistician(int count, double total, double tinyest, double largest, double mean);
